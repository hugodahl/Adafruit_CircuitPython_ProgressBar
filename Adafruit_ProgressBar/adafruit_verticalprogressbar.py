...
class ProgressBar(displayio.TileGrid):
    ...
    :param tuple anchor_position: The anchor coordinates of the progress bar.
    :param tuple size: The size in (width, height) of the progress bar
    ...
    def __init__(
        ...
        print(f"Fill direction: {fill_direction}")
